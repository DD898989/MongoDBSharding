...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="2. 驗證 Web API 負載平衡與多個實體間請求均勻分配")]
        [Xunit.TraitAttribute("FeatureTitle", "MongoDB 讀寫分離與實體分片精準驗證")]
        [Xunit.TraitAttribute("Description", "2. 驗證 Web API 負載平衡與多個實體間請求均勻分配")]
        public async System.Threading.Tasks.Task _2_驗證WebAPI負載平衡與多個實體間請求均勻分配()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("2. 驗證 Web API 負載平衡與多個實體間請求均勻分配", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 20
  this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((global::Reqnroll.TagHelper.ContainsIgnoreTag(scenarioInfo.CombinedTags) || global::Reqnroll.TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
        ...
        [Xunit.SkippableFactAttribute(DisplayName="3. 驗證國家資料僅存在於預設分片而訂單資料均勻分佈於分片一與分片二")]
        [Xunit.TraitAttribute("FeatureTitle", "MongoDB 讀寫分離與實體分片精準驗證")]
        [Xunit.TraitAttribute("Description", "3. 驗證國家資料僅存在於預設分片而訂單資料均勻分佈於分片一與分片二")]
        public async System.Threading.Tasks.Task _3_驗證國家資料僅存在於預設分片而訂單資料均勻分佈於分片一與分片二()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("3. 驗證國家資料僅存在於預設分片而訂單資料均勻分佈於分片一與分片二", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 24
  this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((global::Reqnroll.TagHelper.ContainsIgnoreTag(scenarioInfo.CombinedTags) || global::Reqnroll.TagHelper.ContainsIgnoreTag(featureTags)))
...
#line hidden
#line 42
    await testRunner.AndAsync("我直接連線 \"mymongos\" 查詢，應該存在訂單 \"ORDER_ID_03\"", ((string)(null)), ((global::Reqnroll.Table)(null)), "而且");
#line hidden
#line 43
    await testRunner.AndAsync("我直接連線 \"mymongos\" 查詢，應該存在訂單 \"ORDER_ID_05\"", ((string)(null)), ((global::Reqnroll.Table)(null)), "而且");
#line hidden
            }
            await this.ScenarioCleanupAsync();
        }
        
        [Xunit.SkippableFactAttribute(DisplayName="4. 驗證多次特定 OrderId 查詢時流量均勻路由至對應 Shard 的唯讀副本 (Secondary)")]
        [Xunit.TraitAttribute("FeatureTitle", "MongoDB 讀寫分離與實體分片精準驗證")]
        [Xunit.TraitAttribute("Description", "4. 驗證多次特定 OrderId 查詢時流量均勻路由至對應 Shard 的唯讀副本 (Secondary)")]
        public async System.Threading.Tasks.Task _4_驗證多次特定OrderId查詢時流量均勻路由至對應Shard的唯讀副本Secondary()
        {
            string[] tagsOfScenario = ((string[])(null));
            System.Collections.Specialized.OrderedDictionary argumentsOfScenario = new System.Collections.Specialized.OrderedDictionary();
            global::Reqnroll.ScenarioInfo scenarioInfo = new global::Reqnroll.ScenarioInfo("4. 驗證多次特定 OrderId 查詢時流量均勻路由至對應 Shard 的唯讀副本 (Secondary)", null, tagsOfScenario, argumentsOfScenario, featureTags);
#line 45
  this.ScenarioInitialize(scenarioInfo);
#line hidden
            if ((global::Reqnroll.TagHelper.ContainsIgnoreTag(scenarioInfo.CombinedTags) || global::Reqnroll.TagHelper.ContainsIgnoreTag(featureTags)))
